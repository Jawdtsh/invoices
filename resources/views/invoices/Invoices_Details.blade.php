                                            ...
                                            <div class="table-responsive mt-15">
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $invoicesCollections->invoice_number }}</td>
                                                        <th scope="row">تاريخ الاصدار</th>
                                                        <td>{{ $invoicesCollections->invoice_Date }}</td>
                                                        <th scope="row">تاريخ الاستحقاق</th>
                                                        <td>{{ $invoicesCollections->Due_date }}</td>
                                                        <th scope="row">القسم</th>
                                                        <td>{{ $invoicesCollections?->sections?->section_name }}</td>
                                                    </tr>

                                                    <tr>
                                                        <th scope="row">المنتج</th>
                                                        <td>{{ $invoicesCollections->product->product_name }}</td>
                                                        <th scope="row">مبلغ التحصيل</th>
                                                        <td>{{ $invoicesCollections->Amount_collection }}</td>
                                                        <th scope="row">مبلغ العمولة</th>
                                                        <td>{{ $invoicesCollections->Amount_Commission }}</td>
                                                        <th scope="row">الخصم</th>
                                                        <td>{{ $invoicesCollections->Discount }}</td>
                                                    </tr>


                                                    <tr>
                                                        <th scope="row">نسبة الضريبة</th>
                                                        <td>{{ $invoicesCollections->Rate_VAT }}</td>
                                                        <th scope="row">قيمة الضريبة</th>
                                                        <td>{{ $invoicesCollections->Value_VAT }}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $invoicesCollections->note }}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table-hover"
                                                    ...
                                                    <tbody>
                                                    <?php $i = 0; ?>
                                                    @foreach ($statusesWithPivot as $status)
                                                            <?php $i++; ?>
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            @if($status->id === 1)
                                                            ...
                                                            @else
                                                                <td><span
                                                                            class="badge badge-pill badge-success">{{$status->name}}</span>
                                                                </td>
                                                            @endif


{{--                                                             @if (!empty($statusesWithPivot))--}}
{{--                                                             <td>{{ 'test' }}</td>--}}
{{--                                                            @endif--}}
...
{{--                                                            @if ($zip[0]->$state->id == 1)--}}
{{--                                                                <td><span--}}
{{--                                                                            class="badge badge-pill badge-warning">{{$zip[0]->$state->name }}</span>--}}
{{--                                                                </td>--}}
{{--                                                            @elseif($zip[0]->$state->id ==2)--}}
{{--                                                                <td><span--}}
{{--                                                                            class="badge badge-pill badge-danger">{{ $zip[0]->$state->name }}</span>--}}
{{--                                                                </td>--}}
{{--                                                            @else--}}
{{--                                                                <td><span--}}
{{--                                                                            class="badge badge-pill badge-success">{{$zip[0]->$state->name }}</span>--}}
{{--                                                                </td>--}}
{{--                                                            @endif--}}


{{--                                                             @if (!empty($zip[1]->pivot))--}}
{{--                                                             <td>{{ $zip[1]->pivot->created_at }}</td>--}}
{{--                                                            @endif--}}
